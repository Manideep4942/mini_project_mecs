...
if __name__ == "__main__":
    for filename in glob.glob("D:/MINI_PROJECT_MECS/New folder/Indian-Railways-Automated-Announcement-Software-main/Indian-Railways-Automated-Announcement-Software-mainc"):
        os.remove(filename) 
    print("\n")
